...
public class RuneQBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_q")
	public static final Block block = null;
	public RuneQBlock(TheDeepestDepthsModElements instance) {
		super(instance, 260);
	}
