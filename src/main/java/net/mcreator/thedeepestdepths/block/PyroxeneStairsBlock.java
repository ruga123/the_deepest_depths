...
public class PyroxeneStairsBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:pyroxene_stairs")
	public static final Block block = null;
	public PyroxeneStairsBlock(TheDeepestDepthsModElements instance) {
		super(instance, 6);
	}
