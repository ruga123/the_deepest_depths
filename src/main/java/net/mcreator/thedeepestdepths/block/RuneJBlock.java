...
public class RuneJBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_j")
	public static final Block block = null;
	public RuneJBlock(TheDeepestDepthsModElements instance) {
		super(instance, 253);
	}
