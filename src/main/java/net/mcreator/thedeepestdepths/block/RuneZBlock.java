...
public class RuneZBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_z")
	public static final Block block = null;
	public RuneZBlock(TheDeepestDepthsModElements instance) {
		super(instance, 269);
	}
