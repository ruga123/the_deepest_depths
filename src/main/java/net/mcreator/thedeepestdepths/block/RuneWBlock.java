...
public class RuneWBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_w")
	public static final Block block = null;
	public RuneWBlock(TheDeepestDepthsModElements instance) {
		super(instance, 266);
	}
