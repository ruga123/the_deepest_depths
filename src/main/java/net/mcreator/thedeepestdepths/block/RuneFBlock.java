...
public class RuneFBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_f")
	public static final Block block = null;
	public RuneFBlock(TheDeepestDepthsModElements instance) {
		super(instance, 249);
	}
