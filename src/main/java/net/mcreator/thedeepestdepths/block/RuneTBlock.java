...
public class RuneTBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_t")
	public static final Block block = null;
	public RuneTBlock(TheDeepestDepthsModElements instance) {
		super(instance, 263);
	}
