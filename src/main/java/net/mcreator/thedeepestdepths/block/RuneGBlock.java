...
public class RuneGBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_g")
	public static final Block block = null;
	public RuneGBlock(TheDeepestDepthsModElements instance) {
		super(instance, 250);
	}
