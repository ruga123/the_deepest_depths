...
public class GhostlyLogBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:ghostly_log")
	public static final Block block = null;
	public GhostlyLogBlock(TheDeepestDepthsModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.NETHER_WOOD).sound(SoundType.HYPHAE).hardnessAndResistance(0.6f, 1f).setLightLevel(s -> 2)
					.doesNotBlockMovement().setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("ghostly_log");
		}
