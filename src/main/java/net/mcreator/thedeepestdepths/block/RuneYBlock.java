...
public class RuneYBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_y")
	public static final Block block = null;
	public RuneYBlock(TheDeepestDepthsModElements instance) {
		super(instance, 268);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(5.5f, 5f).setLightLevel(s -> 12).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("rune_y");
		}
