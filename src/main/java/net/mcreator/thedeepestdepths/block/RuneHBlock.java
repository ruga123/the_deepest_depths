...
public class RuneHBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_h")
	public static final Block block = null;
	public RuneHBlock(TheDeepestDepthsModElements instance) {
		super(instance, 251);
	}
