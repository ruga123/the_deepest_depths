...
public class PyroxeneSlabBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:pyroxene_slab")
	public static final Block block = null;
	public PyroxeneSlabBlock(TheDeepestDepthsModElements instance) {
		super(instance, 7);
	}
