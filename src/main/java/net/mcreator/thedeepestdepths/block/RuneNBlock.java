...
public class RuneNBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_n")
	public static final Block block = null;
	public RuneNBlock(TheDeepestDepthsModElements instance) {
		super(instance, 257);
	}
