...
public class RuneDBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_d")
	public static final Block block = null;
	public RuneDBlock(TheDeepestDepthsModElements instance) {
		super(instance, 247);
	}
