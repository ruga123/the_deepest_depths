...
public class RuneKBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_k")
	public static final Block block = null;
	public RuneKBlock(TheDeepestDepthsModElements instance) {
		super(instance, 254);
	}
