...
public class RuneBBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_b")
	public static final Block block = null;
	public RuneBBlock(TheDeepestDepthsModElements instance) {
		super(instance, 245);
	}
