...
public class RuneSBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_s")
	public static final Block block = null;
	public RuneSBlock(TheDeepestDepthsModElements instance) {
		super(instance, 262);
	}
