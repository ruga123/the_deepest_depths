...
public class BloodstoneWallBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:bloodstone_wall")
	public static final Block block = null;
	public BloodstoneWallBlock(TheDeepestDepthsModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodstone_wall");
		}
