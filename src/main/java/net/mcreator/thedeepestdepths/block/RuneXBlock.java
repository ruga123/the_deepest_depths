...
public class RuneXBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_x")
	public static final Block block = null;
	public RuneXBlock(TheDeepestDepthsModElements instance) {
		super(instance, 267);
	}
