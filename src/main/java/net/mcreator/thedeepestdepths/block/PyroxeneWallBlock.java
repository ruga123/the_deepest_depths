...
public class PyroxeneWallBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:pyroxene_wall")
	public static final Block block = null;
	public PyroxeneWallBlock(TheDeepestDepthsModElements instance) {
		super(instance, 8);
	}
