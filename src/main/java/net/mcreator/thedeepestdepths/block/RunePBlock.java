...
public class RunePBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_p")
	public static final Block block = null;
	public RunePBlock(TheDeepestDepthsModElements instance) {
		super(instance, 259);
	}
