...
public class SlateWallBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:slate_wall")
	public static final Block block = null;
	public SlateWallBlock(TheDeepestDepthsModElements instance) {
		super(instance, 236);
	}
