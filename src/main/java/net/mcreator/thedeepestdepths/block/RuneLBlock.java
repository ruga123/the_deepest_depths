...
public class RuneLBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_l")
	public static final Block block = null;
	public RuneLBlock(TheDeepestDepthsModElements instance) {
		super(instance, 255);
	}
