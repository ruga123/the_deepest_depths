...
public class RuneIBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_i")
	public static final Block block = null;
	public RuneIBlock(TheDeepestDepthsModElements instance) {
		super(instance, 252);
	}
