...
public class RuneOBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_o")
	public static final Block block = null;
	public RuneOBlock(TheDeepestDepthsModElements instance) {
		super(instance, 258);
	}
