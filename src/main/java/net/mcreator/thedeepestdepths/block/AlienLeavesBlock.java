...
public class AlienLeavesBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:alien_leaves")
	public static final Block block = null;
	public AlienLeavesBlock(TheDeepestDepthsModElements instance) {
		super(instance, 337);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.4f, 1f).setLightLevel(s -> 12).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("alien_leaves");
		}
