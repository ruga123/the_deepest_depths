...
public class RuneCBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_c")
	public static final Block block = null;
	public RuneCBlock(TheDeepestDepthsModElements instance) {
		super(instance, 246);
	}
