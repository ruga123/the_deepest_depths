...
public class RuneUBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_u")
	public static final Block block = null;
	public RuneUBlock(TheDeepestDepthsModElements instance) {
		super(instance, 264);
	}
