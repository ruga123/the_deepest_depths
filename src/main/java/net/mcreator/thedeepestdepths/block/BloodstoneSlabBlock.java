...
public class BloodstoneSlabBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:bloodstone_slab")
	public static final Block block = null;
	public BloodstoneSlabBlock(TheDeepestDepthsModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bloodstone_slab");
		}
