...
public class BloodshroomBrainBlockBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:bloodshroom_brain_block")
	public static final Block block = null;
	public BloodshroomBrainBlockBlock(TheDeepestDepthsModElements instance) {
		super(instance, 148);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.NETHER_WOOD).sound(SoundType.WART).hardnessAndResistance(1f, 1.2f).setLightLevel(s -> 8)
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("bloodshroom_brain_block");
		}
