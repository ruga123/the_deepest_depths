...
public class RuneEBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_e")
	public static final Block block = null;
	public RuneEBlock(TheDeepestDepthsModElements instance) {
		super(instance, 248);
	}
