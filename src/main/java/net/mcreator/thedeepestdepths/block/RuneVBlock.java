...
public class RuneVBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_v")
	public static final Block block = null;
	public RuneVBlock(TheDeepestDepthsModElements instance) {
		super(instance, 265);
	}
