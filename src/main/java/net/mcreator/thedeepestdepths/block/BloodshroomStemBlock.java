...
public class BloodshroomStemBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:bloodshroom_stem")
	public static final Block block = null;
	public BloodshroomStemBlock(TheDeepestDepthsModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.NETHER_WOOD).sound(SoundType.HYPHAE).hardnessAndResistance(0.8f, 1.4f).setLightLevel(s -> 2)
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("bloodshroom_stem");
		}
