...
public class PurpleDiamondBlockBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:purple_diamond_block")
	public static final Block block = null;
	public PurpleDiamondBlockBlock(TheDeepestDepthsModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_diamond_block");
		}
