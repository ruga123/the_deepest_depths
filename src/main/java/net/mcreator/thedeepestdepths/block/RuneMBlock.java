...
public class RuneMBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_m")
	public static final Block block = null;
	public RuneMBlock(TheDeepestDepthsModElements instance) {
		super(instance, 256);
	}
