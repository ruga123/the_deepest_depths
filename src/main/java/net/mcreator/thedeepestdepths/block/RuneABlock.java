...
public class RuneABlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_a")
	public static final Block block = null;
	public RuneABlock(TheDeepestDepthsModElements instance) {
		super(instance, 244);
	}
