...
public class RuneRBlock extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:rune_r")
	public static final Block block = null;
	public RuneRBlock(TheDeepestDepthsModElements instance) {
		super(instance, 261);
	}
