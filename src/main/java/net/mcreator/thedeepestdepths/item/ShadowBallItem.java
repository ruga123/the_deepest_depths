...
import net.mcreator.thedeepestdepths.entity.renderer.ShadowBallRenderer;
import net.mcreator.thedeepestdepths.TheDeepestDepthsModElements;

import java.util.Random;

@TheDeepestDepthsModElements.ModElement.Tag
public class ShadowBallItem extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:shadow_ball")
	...
	public ShadowBallItem(TheDeepestDepthsModElements instance) {
		super(instance, 411);
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ShadowItemGroup.tab).maxStackSize(16));
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 12, 0);
