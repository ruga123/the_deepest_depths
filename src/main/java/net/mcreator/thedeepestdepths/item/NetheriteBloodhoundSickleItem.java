...
public class NetheriteBloodhoundSickleItem extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:netherite_bloodhound_sickle")
	public static final Item block = null;
	public NetheriteBloodhoundSickleItem(TheDeepestDepthsModElements instance) {
		super(instance, 119);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(BloodhoundFangItem.block, (int) (1)), new ItemStack(Items.NETHERITE_INGOT, (int) (1)));
			}
		...
		}.setRegistryName("netherite_bloodhound_sickle"));
	}
}
