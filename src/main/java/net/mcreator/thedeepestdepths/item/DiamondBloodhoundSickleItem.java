...
public class DiamondBloodhoundSickleItem extends TheDeepestDepthsModElements.ModElement {
	@ObjectHolder("the_deepest_depths:diamond_bloodhound_sickle")
	public static final Item block = null;
	public DiamondBloodhoundSickleItem(TheDeepestDepthsModElements instance) {
		super(instance, 114);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(BloodhoundFangItem.block, (int) (1)), new ItemStack(Items.DIAMOND, (int) (1)));
			}
		...
		}.setRegistryName("diamond_bloodhound_sickle"));
	}
}
