...
public class AlienTreeSpawn14Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AlienTreeSpawn14Structure(TheDeepestDepthsModElements instance) {
		super(instance, 320);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("alien_tree_spawn_14"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:alien_tree_spawn_14"),
					configuredFeature);
		}
	}
	@SubscribeEvent
