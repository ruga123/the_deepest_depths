...
public class GhostlyTree9Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public GhostlyTree9Structure(TheDeepestDepthsModElements instance) {
		super(instance, 200);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ghostly_tree_9"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:ghostly_tree_9"), configuredFeature);
		}
	}
	@SubscribeEvent
