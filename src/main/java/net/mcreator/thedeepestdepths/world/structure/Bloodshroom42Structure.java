...
public class Bloodshroom42Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public Bloodshroom42Structure(TheDeepestDepthsModElements instance) {
		super(instance, 169);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bloodshroom_42"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:bloodshroom_42"), configuredFeature);
		}
	}
	@SubscribeEvent
