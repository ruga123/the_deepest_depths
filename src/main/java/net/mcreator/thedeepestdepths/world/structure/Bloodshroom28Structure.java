...
public class Bloodshroom28Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public Bloodshroom28Structure(TheDeepestDepthsModElements instance) {
		super(instance, 155);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bloodshroom_28"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:bloodshroom_28"), configuredFeature);
		}
	}
	@SubscribeEvent
