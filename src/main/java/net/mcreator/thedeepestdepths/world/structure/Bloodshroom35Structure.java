...
import net.mcreator.thedeepestdepths.procedures.BloodshroomOnStructureInstanceGeneratedProcedure;
...
public class Bloodshroom35Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public Bloodshroom35Structure(TheDeepestDepthsModElements instance) {
		super(instance, 162);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
									...
									random);
							{
								...
								BloodshroomOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
							}
						}
					}
					return true;
			...
			event.getRegistry().register(feature.setRegistryName("bloodshroom_35"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:bloodshroom_35"), configuredFeature);
		}
	}
	@SubscribeEvent
