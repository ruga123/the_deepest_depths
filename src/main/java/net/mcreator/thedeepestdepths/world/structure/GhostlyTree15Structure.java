...
public class GhostlyTree15Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public GhostlyTree15Structure(TheDeepestDepthsModElements instance) {
		super(instance, 206);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ghostly_tree_15"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:ghostly_tree_15"), configuredFeature);
		}
	}
	@SubscribeEvent
