...
public class AlienTreeSpawn11Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AlienTreeSpawn11Structure(TheDeepestDepthsModElements instance) {
		super(instance, 317);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("alien_tree_spawn_11"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:alien_tree_spawn_11"),
					configuredFeature);
		}
	}
	@SubscribeEvent
