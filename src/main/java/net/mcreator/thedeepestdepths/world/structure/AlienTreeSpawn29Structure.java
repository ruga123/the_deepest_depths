...
public class AlienTreeSpawn29Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AlienTreeSpawn29Structure(TheDeepestDepthsModElements instance) {
		super(instance, 335);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("alien_tree_spawn_29"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:alien_tree_spawn_29"),
					configuredFeature);
		}
	}
	@SubscribeEvent
