...
public class AlienTreeSpawn18Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public AlienTreeSpawn18Structure(TheDeepestDepthsModElements instance) {
		super(instance, 324);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("alien_tree_spawn_18"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:alien_tree_spawn_18"),
					configuredFeature);
		}
	}
	@SubscribeEvent
