...
import net.mcreator.thedeepestdepths.procedures.GhostlyTreeOnStructureInstanceGeneratedProcedure;
...
public class GhostlyTree25Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public GhostlyTree25Structure(TheDeepestDepthsModElements instance) {
		super(instance, 216);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000000) {
						...
						for (int a = 0; a < count; a++) {
									...
									random);
							{
								...
								GhostlyTreeOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
							}
						}
					}
					return true;
			...
			event.getRegistry().register(feature.setRegistryName("ghostly_tree_25"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:ghostly_tree_25"), configuredFeature);
		}
	}
	@SubscribeEvent
