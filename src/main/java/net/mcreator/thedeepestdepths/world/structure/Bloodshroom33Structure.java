...
public class Bloodshroom33Structure extends TheDeepestDepthsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public Bloodshroom33Structure(TheDeepestDepthsModElements instance) {
		super(instance, 160);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bloodshroom_33"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("the_deepest_depths:bloodshroom_33"), configuredFeature);
		}
	}
	@SubscribeEvent
