...
public class BloodyBarrensBiome extends TheDeepestDepthsModElements.ModElement {
	public static Biome biome;
	public BloodyBarrensBiome(TheDeepestDepthsModElements instance) {
		super(instance, 25);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(0.1f).scale(0.08f)
						.temperature(0.5f).downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("the_deepest_depths:bloody_barrens"));
			}
		}
	}
	@Override
