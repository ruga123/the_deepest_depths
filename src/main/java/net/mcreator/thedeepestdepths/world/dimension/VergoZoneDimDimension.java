...
public class VergoZoneDimDimension extends TheDeepestDepthsModElements.ModElement {
	public VergoZoneDimDimension(TheDeepestDepthsModElements instance) {
		super(instance, 302);
	}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(AlienRockBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
