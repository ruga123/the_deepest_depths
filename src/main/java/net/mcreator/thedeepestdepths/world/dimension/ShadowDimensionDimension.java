...
import net.mcreator.thedeepestdepths.block.ShadowStoneBlock;
...
public class ShadowDimensionDimension extends TheDeepestDepthsModElements.ModElement {
	public ShadowDimensionDimension(TheDeepestDepthsModElements instance) {
		super(instance, 413);
	}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(ShadowStoneBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("the_deepest_depths:shadow_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
