...
import net.mcreator.thedeepestdepths.procedures.BloodGodThisEntityKillsAnotherOneProcedure;
import net.mcreator.thedeepestdepths.itemgroup.BloodlandsItemGroup;
import net.mcreator.thedeepestdepths.entity.renderer.BloodGodRenderer;
...
public class BloodGodEntity extends TheDeepestDepthsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.5f, 6f)).build("blood_god").setRegistryName("blood_god");
	public BloodGodEntity(TheDeepestDepthsModElements instance) {
		super(instance, 406);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BloodGodRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6815744, -10346464, new Item.Properties().group(BloodlandsItemGroup.tab))
				.setRegistryName("blood_god_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 24);
