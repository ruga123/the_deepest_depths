...
public class BloodhoundRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BloodhoundEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbloodhoundmob(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_deepest_depths:textures/bloodhound.png");
					}
				};
			});
		}
