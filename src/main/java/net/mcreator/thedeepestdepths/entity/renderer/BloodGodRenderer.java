...
@OnlyIn(Dist.CLIENT)
public class BloodGodRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BloodGodEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBloodGod(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("the_deepest_depths:textures/bloodgod.png");
					}
				};
			});
		}
