...
import net.mcreator.thedeepestdepths.procedures.TardagenSpawnThisEntityKillsAnotherOneProcedure;
import net.mcreator.thedeepestdepths.procedures.TardagenOnEntityTickUpdateProcedure;
import net.mcreator.thedeepestdepths.procedures.TardagenAttackConditionProcedure;
import net.mcreator.thedeepestdepths.itemgroup.VergoZoneItemGroup;
import net.mcreator.thedeepestdepths.entity.renderer.TardagenRenderer;
...
public class TardagenEntity extends TheDeepestDepthsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("tardagen").setRegistryName("tardagen");
	public TardagenEntity(TheDeepestDepthsModElements instance) {
		super(instance, 356);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TardagenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3394561, -6750004, new Item.Properties().group(VergoZoneItemGroup.tab))
				.setRegistryName("tardagen_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				TardagenSpawnThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				TardagenOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
